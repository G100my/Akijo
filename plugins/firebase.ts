...
export const vapidKey =
  'BPlCWPfPI5M10xlYqpI-yAkoz8pFhxJf1Pg8b8wAsS7vcAZggn8eOq2vwQ5GW7esycsm5gpvSaLyTvNw9ITtvE8'

const swScript =
  import.meta.env.MODE === 'production'
    ? `/${SERVICEWORKER_FILE_NAME}.js`
    : '/dev-sw.js?dev-sw'
...
async function getRegistration(): Promise<ServiceWorkerRegistration> {
  ...
  if (!registration?.pushManager)
    console.warn(`Not support 'pushManager', `, registration?.pushManager)
  return registration
}
