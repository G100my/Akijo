...
const LinkElements = () =>
  h('p', [
    ...
    h('span', { class: 'whitespace-nowrap' }, [
      h(
        'a',
        { class: 'text-sky-400', target: '_blank', href: 'https://support.google.com/chrome/answer/3220216?hl=zh-Hant&co=GENIE.Platform%3DAndroid' },
        'Google chrome',
      ),
      h('a', { class: 'text-sky-400 ml-5', target: '_blank', href: 'https://support.apple.com/zh-tw/guide/safari/sfri40734/mac' }, 'Safari'),
    ]),
  ])
</script>
<template>
